...
def get_aggs_for_symbol_and_date(symbol_date_pair):
    ...
    print(len(aggs), time.perf_counter()-startTime, len(aggs)/(time.perf_counter()-startTime))
...
def main():
    ...
    end_date = datetime.date(2023, 9, 16)

    symbols = ["X:BTCUSD"]  # The array of symbols you want
